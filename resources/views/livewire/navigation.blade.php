<div class="max-w-7xl mx-auto" x-data="{isOpen:false}">
        <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
            ...
            <div>
                ...
                -->
                <div x-show="isOpen" @click.outside="isOpen=false" x-cloak class="absolute transition duration-200 z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
